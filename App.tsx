...
// Внутри return твоего App.tsx:
<div className="lg:col-span-2">
  <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" style={{ height: '550px' }}>
    <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
      <h2 className="text-lg font-bold text-gray-800">Bursa Malaysia: FCPO Real-Time Chart</h2>
      <span className="text-xs font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded">Live Data</span>
    </div>
